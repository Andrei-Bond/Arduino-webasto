...
#include <CustomSoftwareSerial.h> // Библиотека для 8E1 на программных пинах

// Пины для K-Line адаптера
#define WBUS_RX 8
#define WBUS_TX 9

// Адресация: Таймер (F) -> Котел (4)
#define ADDR_HEATER 0x4F 

// Настройка порта: пины 8 и 9, режим 8 бит, Even parity, 1 стоп-бит
CustomSoftwareSerial wBus(WBUS_RX, WBUS_TX); 

unsigned long lastKeepAlive = 0;
bool webastoIsOn = false;

void setup() {
  Serial.begin(9600); // Для отладки в монитор порта
